"""
Modified from FC-CLIP. (https://raw.githubusercontent.com/bytedance/fc-clip/main/fcclip/modeling/transformer_decoder/fcclip_transformer_decoder.py)
"""
...
class VisionLanguageMultiScaleMaskedTransformerDecoder(nn.Module):
    @configurable
    def __init__(
        self,
        in_channels,
        ...
        *,
        ...
        include_mask_poolings: bool = True,
    ):
        """
        ...
        self.include_mask_poolings = include_mask_poolings
        ...
        # vision-language part modified from FC-CLIP
        logger.info(f"Include mask poolings: {self.include_mask_poolings}")
        if self.include_mask_poolings:
            logger.info("Adding mask pooling layer")
    ...
    def from_config(cls, cfg, in_channels, mask_classification):
        ...
        ret["clip_embedding_dim"] = cfg.MODEL.VL_MASK_FORMER.EMBED_DIM
        ret["include_mask_poolings"] = cfg.MODEL.VL_MASK_FORMER.INCLUDE_MASK_POOLINGS
        return ret
    ...
    def forward_prediction_heads(
        ...
        # Vision language head midified from FC-CLIP
        if self.include_mask_poolings:
