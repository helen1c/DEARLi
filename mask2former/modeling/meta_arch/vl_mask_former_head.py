...
from ..transformer_decoder.vision_language_mask2former_transformer_decoder import (
...
class VisionLanguageMaskFormerHead(nn.Module):
    @configurable
    def __init__(
        self,
    ...
    def layers(self, features, mask=None):
        ...
        if self.transformer_in_feature == "multi_scale_pixel_decoder":
            ...
            raise NotImplementedError(
                'Currenlty just "multi_scale_pixel_decoder" is supported'
            )
        return predictions
