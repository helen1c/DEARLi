...
MetadataCatalog.get("ade20k_panoptic_train_segment").set(
    stuff_colors=ADE20k_COLORS[:],
)

MetadataCatalog.get("ade20k_panoptic_val_segment").set(
    stuff_colors=ADE20k_COLORS[:],
)
...
_PREDEFINED_SPLITS_ADE20K_PANOPTIC = {
    "ade20k_panoptic_train_segment": (
        "ADEChallengeData2016/images/training",
        "ADEChallengeData2016/ade20k_panoptic_train",
        "ADEChallengeData2016/ade20k_panoptic_train_segment.json",
    ),
    "ade20k_panoptic_val_segment": (
        "ADEChallengeData2016/images/validation",
        "ADEChallengeData2016/ade20k_panoptic_val",
        "ADEChallengeData2016/ade20k_panoptic_val_segment.json",
    ),
}
