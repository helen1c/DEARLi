...
_PREDEFINED_SPLITS_ADE20K_PANOPTIC = {
    f"ade20k_panoptic_semi_sup_unlabeled_train_{split}": (
...
def register_all_semisup_unsupervised_ade20k_panoptic(root):
...
register_all_semisup_unsupervised_ade20k_panoptic(_root)
