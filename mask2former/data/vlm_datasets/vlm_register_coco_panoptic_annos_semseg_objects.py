...
from .vlm_classes import get_coco_objects_categories_with_prompt_eng
from detectron2.utils.file_io import PathManager
import logging

logger = logging.getLogger(__name__)

COCO_CATEGORIES = get_coco_objects_categories_with_prompt_eng()

_PREDEFINED_SPLITS_COCO_PANOPTIC = {
    "vlm_coco_2017_train_panoptic": (
        "coco/panoptic_train2017_objects",
        "coco/annotations/panoptic_train2017_objects.json",
        "coco/masks",
    ),
    "vlm_coco_2017_val_panoptic": (
        "coco/panoptic_val2017_objects",
        "coco/annotations/panoptic_val2017_objects.json",
        "coco/masks",
    ),
}
...
def register_coco_panoptic_annos_sem_seg(
    ...
    semantic_name = name + "_with_sem_seg" + "_objects"
