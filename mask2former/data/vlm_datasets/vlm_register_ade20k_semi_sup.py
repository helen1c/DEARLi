...
def load_semisup_ade20k_panoptic_json(
    json_file, image_dir, gt_dir, semseg_dir, meta, split_file
):
    """
    Args:
...
_PREDEFINED_SPLITS_ADE20K_PANOPTIC = {
    f"vlm_ade20k_panoptic_semi_sup_labeled_train_{split}": (
        ...
        f"ade_splits/{split}/labeled.txt",
    )
    for split in ["1_8", "1_16", "1_32", "1_64", "1_128", "150", "300", "450", "600"]
}
...
def register_vlm_all_semisup_ade20k_panoptic(root):
...
register_vlm_all_semisup_ade20k_panoptic(_root)
