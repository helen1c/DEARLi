...
def add_semi_sup_config(cfg):
    ...
    cfg.UNLABELED_INPUT.CUTMIX_ENABLED = False
    cfg.UNLABELED_INPUT.CUTMIX_PROB = 0.5
    ...
    cfg.UNLABELED_INPUT.STUDENT_JITTER.COLOR_JITTER.BRIGHTNESS = 0.8
    cfg.UNLABELED_INPUT.STUDENT_JITTER.COLOR_JITTER.CONTRAST = 0.8
    cfg.UNLABELED_INPUT.STUDENT_JITTER.COLOR_JITTER.SATURATION = 0.8
    ...
    cfg.MODEL.TEACHER.TYPE = "plain_m2f"  # allowed values: "plain_m2f", "vl_m2f"
    ...
    cfg.MODEL.TEACHER.OBJECT_MASK_THRESHOLD = None
...
def add_vl_maskformer2_config(cfg):
    cfg.MODEL.VL_MASK_FORMER = CN()
    cfg.MODEL.VL_MASK_FORMER.OPEN_CLIP_MODEL_NAME = ""
    cfg.MODEL.VL_MASK_FORMER.OPEN_CLIP_PRETRAINED_WEIGHTS = ""
    cfg.MODEL.VL_MASK_FORMER.GEOMETRIC_ENSEMBLE_ALPHA = 0.4
    cfg.MODEL.VL_MASK_FORMER.ENSEMBLE_ON_VALID_MASK = False
    cfg.MODEL.VL_MASK_FORMER.EMBED_DIM = 640
    cfg.MODEL.VL_MASK_FORMER.FREEZE_BACKBONE = True

    cfg.MODEL.VL_MASK_FORMER.STUDENT = CN()
    cfg.MODEL.VL_MASK_FORMER.STUDENT.USE_ZERO_SHOT_BRANCH = True
    cfg.MODEL.VL_MASK_FORMER.TEACHER = CN()
    cfg.MODEL.VL_MASK_FORMER.TEACHER.USE_ZERO_SHOT_BRANCH = True
    cfg.MODEL.VL_MASK_FORMER.INCLUDE_MASK_POOLINGS = False
