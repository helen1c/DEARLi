...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if (
            evaluator_type in ["ade20k_panoptic_seg"]
    ...
    def build_train_loader(cls, cfg):
        ...
        if cfg.INPUT.DATASET_MAPPER_NAME == "mask_former_instance_sa1b":
            mapper = MaskFormerInstanceDatasetMapperSA1B(cfg, True)
...
def main(args):
    ...
    if args.eval_only:
        ...
        if cfg.TEST.AUG.ENABLED:
            raise NotImplementedError("Test time augmentation not implemented")
